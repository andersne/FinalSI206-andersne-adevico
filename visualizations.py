...
def CovidCasesBarGraph(state, cur, conn):
    """Takes in the database cursor and connection. For the inputted state, creates a bar graph displaying 
    ...
    plt.bar(x_pos, y_pos, color='blue')
...
def DoubleHistogram(states, cur, conn):
    """Takes in the database cursor and connection. Creates a double histogram 
...
def PovertyVSDeathScatter(states, cur, conn):
    """Takes in the database cursor and connection. Creates a double scatterplot 
...
def PovertyVSPositivityScatter(states, cur, conn):
    """Takes in the database cursor and connection. Creates a double scatter plot comparing the 
